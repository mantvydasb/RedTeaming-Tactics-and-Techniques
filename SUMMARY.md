...
* [Active Directory & Kerberos Abuse](offensive-security-experiments/active-directory-kerberos-abuse/README.md)
  ...
  * [Kerberos Unrestricted Delegation](offensive-security-experiments/active-directory-kerberos-abuse/domain-compromise-via-unrestricted-kerberos-delegation.md)
...
* [Initial Access](offensive-security/initial-access/README.md)
  ...
  * [T1187: Forced Authentication](offensive-security/initial-access/t1187-forced-authentication.md)
...
* [Windows Kernel](miscellaneous-reversing-forensics/windows-kernel/README.md)
  ...
  * [Token Abuse for Privilege Escalation in Kernel](miscellaneous-reversing-forensics/windows-kernel/how-kernel-exploits-abuse-tokens-for-privilege-escalation.md)
  * [Manipulating ActiveProcessLinks to Hide Processes in Userland](miscellaneous-reversing-forensics/windows-kernel/manipulating-activeprocesslinks-to-unlink-processes-in-userland.md)
  * [Windows Kernel Drivers 101](miscellaneous-reversing-forensics/windows-kernel/windows-kernel-drivers-101.md)
  * [Compiling a Simple Kernel Driver, DbgPrint, DbgView](miscellaneous-reversing-forensics/windows-kernel/compiling-first-kernel-driver-kdprint-dbgprint-and-debugview.md)
  * [Sending Commands from your Userland Program to your Kernel Driver via IOCTL](miscellaneous-reversing-forensics/windows-kernel/sending-command-from-userland-to-your-kernel-driver-via-ioctl.md)
