...
* [Code Execution](offensive-security/code-execution/README.md)
  ...
  * [MSHTA](offensive-security/code-execution/t1170-mshta-code-execution.md)
  * [Control Panel Item](offensive-security/code-execution/t1196-control-panel-item-code-execution.md)
...
* [Defense Evasion](offensive-security/defense-evasion/README.md)
  ...
  * [Hidden Files](offensive-security/defense-evasion/t1158-hidden-files.md)
  * [Encode/Decode Data with Certutil](offensive-security/defense-evasion/t1140-encode-decode-data-with-certutil.md)
  * [Downloading Files with Certutil](offensive-security/defense-evasion/downloading-file-with-certutil.md)
  * [Packed Binaries](offensive-security/defense-evasion/t1045-software-packing-upx.md)
...
* [Privilege Escalation](offensive-security/privilege-escalation/README.md)
  * [Primary Access Token Manipulation](offensive-security/privilege-escalation/t1134-access-token-manipulation.md)
  ...
  * [DLL Hijacking](offensive-security/privilege-escalation/t1038-dll-hijacking.md)
  * [WebShells](offensive-security/privilege-escalation/t1108-redundant-access.md)
  * [Image File Execution Options Injection](offensive-security/privilege-escalation/t1183-image-file-execution-options-injection.md)
...
* [Credential Access & Dumping](offensive-security/credential-access-and-credential-dumping/README.md)
  ...
  * [Credentials in Registry](offensive-security/credential-access-and-credential-dumping/t1214-credentials-in-registry.md)
  * [Password Filter](offensive-security/credential-access-and-credential-dumping/t1174-password-filter-dll.md)
...
* [Lateral Movement](offensive-security/lateral-movement/README.md)
  ...
  * [WMI for Lateral Movement](offensive-security/lateral-movement/t1047-wmi-for-lateral-movement.md)
  * [RDP Hijacking for Lateral Movement with tscon](offensive-security/lateral-movement/t1076-rdp-hijacking-for-lateral-movement.md)
  * [Shared Webroot](offensive-security/lateral-movement/t1051-shared-webroot.md)
  * [Lateral Movement via DCOM](offensive-security/lateral-movement/t1175-distributed-component-object-model.md)
...
* [Persistence](offensive-security/persistence/README.md)
  ...
  * [Schtask](offensive-security/persistence/t1053-schtask.md)
  ...
  * [Screensaver Hijack](offensive-security/persistence/t1180-screensaver-hijack.md)
  * [Application Shimming](offensive-security/persistence/t1138-application-shimming.md)
  * [BITS Jobs](offensive-security/persistence/t1197-bits-jobs.md)
  * [COM Hijacking](offensive-security/persistence/t1122-com-hijacking.md)
  * [SIP & Trust Provider Hijacking](offensive-security/persistence/t1198-trust-provider-hijacking.md)
  * [Hijacking Time Providers](offensive-security/persistence/t1209-hijacking-time-providers.md)
  * [Installing Root Certificate](offensive-security/persistence/t1130-install-root-certificate.md)
...
* [Internals](miscellaneous-reversing-forensics/windows-linux-os-internals/README.md)
  * [Configuring Kernel Debugging Environment with kdnet and WinDBG Preview](miscellaneous-reversing-forensics/windows-linux-os-internals/configuring-kernel-debugging-environment-with-kdnet-and-windbg-preview.md)
  * [Compiling a Simple Kernel Driver, DbgPrint, DbgView](miscellaneous-reversing-forensics/windows-linux-os-internals/compiling-first-kernel-driver-kdprint-dbgprint-and-debugview.md)
  * [Loading Windows Kernel Driver for Debugging](miscellaneous-reversing-forensics/windows-linux-os-internals/loading-a-windows-kernel-driver-osr-driver-loader-debugging-with-source-code.md)
  * [Subscribing to Process Creation, Thread Creation and Image Load Notifications from a Kernel Driver](miscellaneous-reversing-forensics/windows-linux-os-internals/subscribing-to-process-creation-thread-creation-and-image-load-notifications-from-a-kernel-driver.md)
  * [Listing Open Handles and Finding Kernel Object Addresses](miscellaneous-reversing-forensics/windows-linux-os-internals/get-all-open-handles-and-kernel-object-address-from-userland.md)
  * [Sending Commands From Your Userland Program to Your Kernel Driver using IOCTL](miscellaneous-reversing-forensics/windows-linux-os-internals/sending-commands-from-userland-to-your-kernel-driver-using-ioctl.md)
  * [Windows Kernel Drivers 101](miscellaneous-reversing-forensics/windows-linux-os-internals/windows-kernel-drivers-101.md)
  * [Windows x64 Calling Convention: Stack Frame](miscellaneous-reversing-forensics/windows-linux-os-internals/windows-x64-calling-convention-stack-frame.md)
  * [Linux x64 Calling Convention: Stack Frame](miscellaneous-reversing-forensics/windows-linux-os-internals/linux-x64-calling-convention-stack-frame.md)
  * [System Service Descriptor Table - SSDT](miscellaneous-reversing-forensics/windows-linux-os-internals/glimpse-into-ssdt-in-windows-x64-kernel.md)
  * [Interrupt Descriptor Table - IDT](miscellaneous-reversing-forensics/windows-linux-os-internals/interrupt-descriptor-table-idt.md)
  * [Token Abuse for Privilege Escalation in Kernel](miscellaneous-reversing-forensics/windows-linux-os-internals/how-kernel-exploits-abuse-tokens-for-privilege-escalation.md)
  * [Manipulating ActiveProcessLinks to Hide Processes in Userland](miscellaneous-reversing-forensics/windows-linux-os-internals/manipulating-activeprocesslinks-to-unlink-processes-in-userland.md)
  * [ETW: Event Tracing for Windows 101](miscellaneous-reversing-forensics/windows-linux-os-internals/etw-event-tracing-for-windows-101.md)
  * [Exploring Injected Threads](miscellaneous-reversing-forensics/windows-linux-os-internals/get-injectedthread.md)
  * [Parsing PE File Headers with C++](miscellaneous-reversing-forensics/windows-linux-os-internals/pe-file-header-parser-in-c++.md)
  * [Instrumenting Windows APIs with Frida](miscellaneous-reversing-forensics/windows-linux-os-internals/instrumenting-windows-apis-with-frida.md)
  * [Exploring Process Environment Block](miscellaneous-reversing-forensics/windows-linux-os-internals/exploring-process-environment-block.md)
  * [Writing a Custom Bootloader](miscellaneous-reversing-forensics/windows-linux-os-internals/writing-a-custom-bootloader.md)
