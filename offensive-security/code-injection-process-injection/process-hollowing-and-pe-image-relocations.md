...
{% page-ref page="../../reversing-forensics/pe-file-header-parser-in-c++.md" %}
...
Now, in order to hollow out the destination process, we need to know its `ImageBaseAddress`. We can get the location of image base address from the [PEB](../../reversing-forensics/exploring-process-environment-block.md) structure of the host process via WinDBG - we know that the PEB is located at 0100e000:
